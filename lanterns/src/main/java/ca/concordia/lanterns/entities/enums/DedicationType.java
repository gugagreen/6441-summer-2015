...
public enum DedicationType {
	FOUR_OF_A_KIND(new int[]{8,7,7,6,6,5,5,4,4}, new int[]{8,7,6,6,5,5,4,4}, new int[]{8,7,6,5,4,4}), 
	THREE_PAIRS(new int[]{9,8,8,7,7,6,6,5,4}, new int[]{9,8,7,7,6,6,5,4}, new int[]{9,8,7,6,5,4}), 

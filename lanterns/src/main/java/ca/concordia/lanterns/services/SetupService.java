...
public interface SetupService {
	...
	/**
	 * Setup step #1:
	 * <p>Place the starting Lake Tile in the center of the play area face down. Flip the tile face up and orient it so that one
	...
	/**
	 * Setup step #2:
	 * <p>Deal 3 Lake Tiles to each player face down. Lake Tiles are held in hand and kept secret from other players.
	 * 
	 * @param totalTiles
	 * @param players
	...
	/**
	 * Setup step #3:
	 * <p>Create a draw stack of Lake Tiles. The number of tiles in the stack depends on player count:
	 * <ul>
	 ...
	 * Setup step #4:
	 * 
	 * <p>Separate the Lantern Cards by color into 7 stacks. These stacks are collectively called the supply The number of cards
	 * <p>in each stack depends on player count:
	 * <ul>
	 ...
	 * <p>
	 * Setup step #6: 
	 * Separate Dedication Tokens by type into 3 stacks. Arrange each stack in descending order of value. 
	 * <ul>
	 ...
	 * players Lantern Cards are always kept in front of them, visible for everyone to see.
	 * <p>

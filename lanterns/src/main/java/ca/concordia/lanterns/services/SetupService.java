...
public interface SetupService {
     ...
     * @param totalTiles  total stack of tiles in the game.
     ...
     * @param playerCount number of players in the game.
     * @throws IllegalArgumentException If cards stack arrays are not prepared to be populated.
     */
     ...
     * @param playerCount number of players in the game.
     * @throws IllegalArgumentException If dedications stack arrays are not prepared to be populated.
     */
